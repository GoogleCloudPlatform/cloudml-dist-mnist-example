...
5. Follow the [instruction](https://github.com/GoogleCloudPlatform/cloudml-dist-mnist-example/blob/v2.0/notebooks/Online%20prediction%20example.ipynb) in the notebook.
